...
public class UserServiceImpl implements UserService {
    ...
    public User registerUser(UserRegistrationDTO dto) {
        if (!dto.getEmail().toLowerCase().endsWith("@glbitm.ac.in")) {
//            throw new RuntimeException("University email id needed. Please use a valid @glbitm.ac.in email address.");
            throw new UniveristyEmailException("University email id needed. Please use a valid @glbitm.ac.in email address.");
        }
